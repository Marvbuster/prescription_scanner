...
export default function BoundsDemo() {
  ...
  // Update bounds when slider changes
  useEffect(() => {
  ...
  const startCamera = async () => {
    ...
    try {
      ...
      setIsScanning(true);
      // Update computed bounds after camera starts
      ...
      <div className="max-w-lg mx-auto p-6">
        ...
        <div className="mb-4">
          ...
          >
            ...
            {/* Scan Bounds Overlay - positioned based on bounds */}
            {isScanning && (
              <>
                {/* Dark overlay outside bounds */}
                <div
        ...
        <div className="bg-zinc-900/50 backdrop-blur rounded-2xl border border-zinc-800 p-4 mb-4">
          ...
          {computedBounds && (
            <div className="mt-4 p-3 bg-zinc-800/50 rounded-lg">
              <p className="text-xs text-zinc-500 mb-1">Berechnete Pixel-Werte:</p>
              <code className="text-xs text-emerald-400">
                {`{ x: ${computedBounds.x}, y: ${computedBounds.y}, width: ${computedBounds.width}, height: ${computedBounds.height} }`}
              </code>
            </div>
          )}
        </div>
